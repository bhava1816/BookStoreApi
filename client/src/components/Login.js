...
let onload=async()=>{
    ...
    let response=await fetch("bookstoreapi-2.onrender.com/load",{method:"POST",body:mybody})
...
useEffect(()=>{
  ...
  let myfunction=async()=>{
     ...
     let response=await fetch("bookstoreapi-2.onrender.com/login",{method:"POST",body:mybody})
     let jsodata=await response.json()
